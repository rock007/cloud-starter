...
public class RedisUtil {
	...
	private static int DTABASE_INDEX = PropertiesFileUtil.getInstance("redis").getInt("master.redis.database");
	...
	private static void initialPool() {
		try {
			...
			_log.warn("redis setting ip:"+IP+" port: " + PORT);
